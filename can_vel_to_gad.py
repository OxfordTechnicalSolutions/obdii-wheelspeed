...
stream_id = 157 # Must be between 128 and 255
...
for msg in bus:
   ...
   # Forward is 1st set of 2 bytes, little endian, signed
      ...
      print(vf)
      gad_vel = oxts_sdk.GadVelocity(stream_id)
      gad_vel.vel_odom = [vf, 0, 0]
      gad_vel.vel_odom_var = [0.02*vf, 200, 200]
      gad_vel.time_latency = 0.1 # Just an estimate, could measure for better results
      gad_vel.set_aiding_lever_arm_config()

      gad_hand.send_packet(gad_vel)
